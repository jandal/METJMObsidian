...
dv.paragraph(`
<div style="font-size: 100px; font-weight: bold; line-height: 0.9; padding: 0; margin: -20px 0px 0px 0px; text-align: centre;">
  <div style="color: ${color}; padding: 0; margin: 0;">${pcFile?.hit_points_current || "?"}</div>
</div>
`)
```
