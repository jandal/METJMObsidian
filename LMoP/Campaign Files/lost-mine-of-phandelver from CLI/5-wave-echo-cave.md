...
| 4-5 | [Ghouls](ghoul.md) (`d4`) |
| 6 | [Gricks](grick.md) (`d4`) |
| 7-8 | [Bugbears](bugbear.md) (`d4`) |
| 9 | [Skeletons](skeleton.md) (`d6`) |
| 10 | [Zombies](zombie.md) (`d6`) |
| 11-12 | [Ochre Jelly](ochre-jelly.md) (1) |
^wandering-monsters

> [!gallery]
> ![Wave Echo Cave](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/wave-echo-cave.webp#gallery)
> ![Player Version](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/wave-echo-cave-player.webp#gallery)
...
Clinging to the ceiling like bats are ten [stirges](stirge.md). The monsters find scant living prey in the mines, and they are ravenous. If the characters are looking down at the skeletons on the floor, the stirges are likely get the drop on them. Any character who isn't watching the ceiling is [surprised](conditions.md#Surprised) unless his or her passive Wisdom ([Perception](skills.md#Perception)) score is higher than the stirges' Dexterity ([Stealth](skills.md#Stealth)) check total (roll once for all of them). Characters who aren't [surprised](conditions.md#Surprised) hear a flapping noise as the stirges descend to attack.
...
The escarpments are 10 feet high and require a successful DC 12 Strength ([Athletics](skills.md#Athletics)) check to climb. A creature that falls or is knocked from the top of a ledge takes `d6` bludgeoning damage and lands [prone](conditions.md#Prone).
...
Any character proficient in [Arcana](skills.md#Arcana) can sense a subtle aura of magic in this cavern. (A [detect magic](detect-magic.md) spell reveals the same.) The aura becomes stronger as one approaches the northern building (15).
...
A successful DC 15 Intelligence ([Arcana](skills.md#Arcana)) check identifies the brazier as the source of the magic that suffuses the surrounding caverns. This magic has waned over the years, to the extent that it can no longer be harnessed to permanently enchant magic items. However, any nonmagical weapon or armor bathed in the green flame for at least 1 minute becomes a [+1 weapon](1-weapon.md) or [+1 armor](1-armor.md), respectively, for `d12` hours. The brazier cannot be removed from the Forge of Spells.
...
The rift is 20 feet deep. Climbing up or down without using a rope requires a successful DC 10 Strength ([Athletics](skills.md#Athletics)) check. A creature that fails the check by 5 or more falls and takes `d6` bludgeoning damage per 10 feet fallen, landing [prone](conditions.md#Prone) at the bottom.
...
The statue depicts Dumathoin, the dwarven god of mining. Any character who has proficiency in [Religion](skills.md#Religion) recognizes the deity. The statue is beautifully carved, and its emerald eyes appear extremely valuable. However, the jewels are clever fakes made of worthless glass, as close inspection and a successful DC 15 Intelligence ([Investigation](skills.md#Investigation)) check reveals. Nevertheless, a powerful spell protects them, and a [detect magic](detect-magic.md) spell reveals a strong aura of abjuration magic surrounding the statue.
