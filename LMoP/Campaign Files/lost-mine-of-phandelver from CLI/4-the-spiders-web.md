...
> [!gallery]
> ![The Sword Coast](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/the-sword-coast.webp#gallery)
> ![Player Version](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/the-sword-coast-player.webp#gallery)
...
> [!gallery]
> ![Ruins of Thundertree](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/ruins-of-thundertree.webp#gallery)
> ![Player Version](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/ruins-of-thundertree-player.webp#gallery)
...
Two [twig blights](twig-blight.md) hide among the weeds that flank the cottage's open doorway. Make a Dexterity ([Stealth](skills.md#Stealth)) check for the blights, and compare the result to the passive Wisdom ([Perception](skills.md#Perception)) scores of the characters to determine if the blights are spotted.
...
The overgrowth conceals a deadly threat-six [twig blights](twig-blight.md) lurking among the ordinary foliage. Spotting them requires a successful Wisdom ([Perception](skills.md#Perception)) check challenged by the blights' Dexterity ([Stealth](skills.md#Stealth)) check.
...
Two [giant spiders](giant-spider.md) hide on the inner walls in this ruined building, so they are not visible from outside. Trailing lines from the webs in the lane allow the spiders to sense when prey is moving through the webs, at which point they nimbly scuttle over the wall and attack. The alert spiders surprise any character whose passive Wisdom ([Perception](skills.md#Perception)) score is less than 17.
...
Six [twig blights](twig-blight.md) lurk in the thicket south of this ruin. Allow each character to attempt a Wisdom ([Perception](skills.md#Perception)) check contested by the blights' Dexterity ([Stealth](skills.md#Stealth)) check to avoid being [surprised](conditions.md#Surprised) by them.
...
> [!gallery]
> ![Cragmaw Castle](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/cragmaw-castle.webp#gallery)
> ![Player Version](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/cragmaw-castle-player.webp#gallery)
...
All that remains of the tower's second floor is a jagged ledge, upon which sits a battered wooden chest. The chest is hard to see from the floor, requiring a successful DC 15 Wisdom ([Perception](skills.md#Perception)) check to notice. The chest is unlocked and contains 90 ep, 120 gp, a [potion of healing](potion-of-healing.md), a [scroll of](spell-scroll-2nd-level.md) [silence](silence.md), and a [scroll of](spell-scroll-3rd-level.md) [revivify](revivify.md).
