...
The party might need to [[Rests|rest]] after the goblin ambush, depending on how the battle plays out. See the rulebook for more information on short rests and long rests.
...
> [!gallery]
> ![Cragmaw Hideout](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/cragmaw-hideout.webp#gallery)
> ![Player Version](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/cragmaw-hideout-player.webp#gallery)
...
The hot coals in the central fire pit deal 1 fire damage to any creature that enters the fire pit, or `d6` fire damage to any creature that falls [prone](conditions.md#Prone) there. A creature can take each type of damage only once per round.
