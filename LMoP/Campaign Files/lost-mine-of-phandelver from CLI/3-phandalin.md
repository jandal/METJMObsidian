...
> [!gallery]
> ![Phandalin](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/phandalin.webp#gallery)
> ![Player Version](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/phandalin-player.webp#gallery)
...
> [!gallery]
> ![Redbrand Hideout](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/redbrand-hideout.webp#gallery)
> ![Player Version](Campaigns/LMoP/Campaign%20Files/lost-mine-of-phandelver%20from%20CLI/img/redbrand-hideout-player.webp#gallery)
...
Currently heaped at the bottom among broken and well-gnawed bones is the half-eaten body of Thel Dendrar, the woodcarver of Phandalin who was murdered by the Redbrands. The outlaws left his corpse here for the nothic to feed on. [[DND/3-Mechanics/CLI/spells/fireball|fireball]]
...
Three [bugbears](bugbear.md) and one [goblin](goblin.md) are present. The goblin, Droop, falls [unconscious](conditions.md#Unconscious) at the sight of the party, but another creature can use an action to wake him. Otherwise, Droop remains [unconscious](conditions.md#Unconscious) for `d10` minutes.
...
Iarno is trying to master the art of brewing potions and concocting alchemical mixtures. The books and notes scattered around the room are basic texts on alchemy. Any character proficient in [Arcana](skills.md#Arcana) can see that Iarno's apparatus appears to be set up to brew [potions of invisibility](potion-of-invisibility.md), not that he has succeeded so far.
